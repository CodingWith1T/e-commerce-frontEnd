...
const AddressCard = ({selectedId, addressInfo, handleDeleteAddress, handleEditAddress, setCurrentSelectedAddress}) => {

  return (
   <Card className={`${selectedId?._id === addressInfo?._id ? 'border-black' : ''} cursor-pointer`} onClick={()=>setCurrentSelectedAddress ? setCurrentSelectedAddress(addressInfo) : null }>
